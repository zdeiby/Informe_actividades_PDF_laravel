...
<body>
    ...
    <div id="header">
    <table style="width: 100%; border:1px solid black; text-align:center;font-size:15px" class="content">
    <tr>
...
<table style="width: 100%; border:1px solid black; text-align:center">
    <tr>
        <td style="width: 33.33%;border:1px solid black;background:#E6E6E6;font-weight:bold">OBLIGACIONES CONTRACTUALES </td>
        <td style="width: 33.33%;border:1px solid black;background:#E6E6E6;font-weight:bold">DESARROLLO DE ACTIVIDADES </td>
        <td style="width: 33.33%;border:1px solid black;background:#E6E6E6;font-weight:bold">EVIDENCIAS </td>
    </tr>
</table>
   ...
   <table style="width: 100%; border:1px solid black; text-align:center">
    <tr>
        <td style="width: 33.33%;border:1px solid black;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci quod at quo sunt ut quaerat sint quas quae sit impedit nesciunt, quasi placeat ex omnis accusamus. Iste excepturi accusantium esse!</td>
        <td style="width: 33.33%;border:1px solid black;">En física, una onda es una propagación de una perturbación de alguna propiedad de un medio, por ejemplo, densidad, presión, campo eléctrico o campo magnético, que se propaga a través del espacio transportando energía. El medio perturbado puede ser de naturaleza diversa como aire, agua, un trozo de metal o el vacío.</td>
        <td style="width: 33.33%;border:1px solid black;"><img src="assets/img1.jpg" width="100%"/></td>
    </tr>
</table>
...
<table style="width: 100%; border:1px solid black; text-align:center">
    <tr>
        <td style="width: 33.33%;border:1px solid black;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci quod at quo sunt ut quaerat sint quas quae sit impedit nesciunt, quasi placeat ex omnis accusamus. Iste excepturi accusantium esse!</td>
        <td style="width: 33.33%;border:1px solid black;"> densidad, presión, campo eléctrico o campo magnético, que se propaga a través del espacio transportando energía. El medio perturbado puede ser de naturaleza diversa como aire, agua, un trozo de metal o el vacío.</td>
        <td style="width: 33.33%;border:1px solid black;"><img src="assets/img1.jpg" width="100%"/></td>
    </tr>
</table>
